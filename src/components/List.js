        ...
        return (
          ...
          >
            ...
            <div className="relative z-10 p-6 flex flex-col h-full">
              ...
              {/* Links + Button grouped at bottom (always aligned) */}
              <div className="mt-auto flex flex-col gap-4">
                {/* Quick Links — fixed height; scroll if overflow */}
                <div>
                  <div className="h-16 sm:h-20 overflow-y-auto overscroll-contain pr-1 flex flex-wrap gap-2">
                    <Links school={school} />
                  </div>
                </div>
